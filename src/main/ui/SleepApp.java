...
//The class for running the sleep app
public class SleepApp {
    ...
    private void seeAll() {
        ...
        for (int i = 0; i < num; i++) {
            ...
            System.out.print("Sleep " + (i + 1) + " " + s.getDatee().getYear() + "/" + s.getDatee().getMonth() + "/");
            System.out.print(s.getDatee().getDay() + " | " + " Hour: " + s.getTime() + " | " + " Score: ");
